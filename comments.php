...
<?php if ( 'open' == $post->comment_status ) : ?>
                <div id="respond">
                    <h3><?php comment_form_title( __('Leave your Message', 'hbd-theme'), __('Post a Reply to %s', 'hbd-theme') ); ?></h3>
...
<?php else : ?>
              ...
              <div id="form-section-author" class="form-section">
                                ...
                                <div class="form-input"><input id="author" name="author" type="text" value="<?php echo $comment_author ?>" size="30" maxlength="50" tabindex="3" /></div>
...
<?php endif /* if ( $user_ID ) */ ?>
             ...
             <!-- <div id="form-allowed-tags" class="form-section">
                  <p><span><?php //_e('You may use these <abbr title="HyperText Markup Language">HTML</abbr>', 'hbd-theme') ?></span> <code><?php //echo allowed_tags(); ?></code></p>
              </div> -->
 
<?php do_action('comment_form', $post->ID); ?>
 
                            <div class="form-submit"><input id="submit" name="submit" type="submit" value="<?php _e('Add Message', 'hbd-theme') ?>" tabindex="7" /><input type="hidden" name="comment_post_ID" value="<?php echo $id; ?>" /></div>
